...
export default function TicketRouter({ presentation, status, departure, arrival }: TicketRouterProps) {
  return (
    <View style={presentation === 'trip' ? s.tripContainer : s.ticketContainer}>
      ...
      <View style={s.centerContainer}>
        ...
        {presentation === 'ticket' && status ? (
          ...
          <Text style={s.tripDataText}>{formatDate(departure.dataPartida)}</Text>
        )}
      </View>
